     <aside id="slide-out" class="side-nav white fixed" style="background-image: linear-gradient(to left, #4ca1af , #c4e0e5)!important;">
         <div class="side-nav-wrapper">
             <div class="sidebar-profile">

                 <div class="sidebar-profile-info">

                     <h5 style="font-weight: 500;">Admin</h5>
             ...
             <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                 ...
                 <li class="no-padding"><a class="waves-effect waves-grey" href="changepassword.php">Chnage Password</a></li>

                 <li class="no-padding">
                     <a class="waves-effect waves-grey" href="logout.php">Log Out</a>
                 </li>
