...
<body style="background-color: #e6ecff;">
    <nav class="navbar navbar-expand-lg navbar-light py-3" style="background-image: linear-gradient(to right, #02aab0 , #00cdac)!important;">
                    ...
                    <div class="col-md-6 d-flex justify-content-center align-items-center">
                        <div class="card white darken-1">
                            <div class="card-content">
                                <span class="card-title text-danger" style="font-size:20px;color: #6666ff !important;"">Admin Login</span>
                                <div class=" row">
                                    <form class="col s12" name="signin" method="post">
                                        ...
                                        <div class="col s12 center m-t-sm">
                                            ...
                                            <input type="submit" name="signin" value="Login" class="waves-effect waves-light btn teal btn2">
                                        </div>
                                    </form>
                            </div>
                        </div>
